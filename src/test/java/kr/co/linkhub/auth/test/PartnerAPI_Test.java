...
public class PartnerAPI_Test {
    ...
    public void PartnerMemberPointList() throws LinkhubException {
		...
		TokenBuilder tokenBuilder = 
				...
				.ServiceID("POPBILL") // 운용환경은 "POPBILL", 테스트환경은 "POPBILL_TEST" 기재
		...
		String[] MemberCorpNums = new String[]{
				...
				"2309582351","4364364331","2030273881","2309482392","2305982300","2352345320","3029482305","2309580921","000-00-00900	"};
